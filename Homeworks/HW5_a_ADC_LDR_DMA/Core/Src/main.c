...
int main(void)
{
  ...
  //TIM2 will start a conversion in the ADC every 1ms
  //every 1000 conversions, the adc callback (half or complete) will calculate the average and
