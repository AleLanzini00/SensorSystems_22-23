...
//every 4 ms read a column
//if a new value is read and the debounce time has expired ( 4*4 ms in our case) send the character
...
int main(void)
{
  ...
  //turn on the first column and off the others
