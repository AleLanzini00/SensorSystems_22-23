...
int main(void)
{
  ...
  //every time the timer triggers, the ADC will automatically start a new conversion
  //the result of the conversion will be read and sent in the ADC_ConvCpltCallback()
